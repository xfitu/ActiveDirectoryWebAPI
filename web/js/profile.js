...
$(document).ready(function(){
  //global variables for name and username to be used later, 
  //their values maybe set in the session variables   
  ...
  function GetUserDetails(name){
    ...
    if(name!==null){     
        dataString = "name="+name;
         $.ajax({
                type: "POST",
                url: "https://localhost:7443/ActiveDirectoryWebAPI/GetAnUserAttributes",
                data: dataString,
                dataType: "json",
...
//check if all the input has value since they all are required for user registration    
    if(newfname!==null&&newlname!==null&&name!==null){    
        ...
        dataString = "name="+name+"&newfname="+newfname+"&newlname="+newfname;
         $.ajax({
                type: "POST",
                url: "https://localhost:7443/ActiveDirectoryWebAPI/UpdateName",
                data: dataString,
                dataType: "json",
               success: function(result) {
 ...
 //check if all the input has value since they all are required for user registration    
    if(newusername!==null&&name!==null){    
        ...
        dataString = "name="+name+"&newusername="+newusername;
         $.ajax({
                type: "POST",
                url: "https://localhost:7443/ActiveDirectoryWebAPI/UpdateUsername",
                data: dataString,
                dataType: "json",
               success: function(result) {
                    ShowSuccessMessage(result);
...
//check if all the input has value since they all are required for user registration    
    if(username!==null&&name!==null&&newpassword!==null&&newpassword.length>=8){    
        //get the form data and then serialize that
...
//check if all the input has value since they all are required for user registration    
    if(role!==null&&name!==null){    
        ...
        dataString = "name="+name+"&groupname="+role;
         $.ajax({
                type: "POST",
                url: "https://localhost:7443/ActiveDirectoryWebAPI/AddUserToGroup",
                data: dataString,
                dataType: "json",
               success: function(result) {
                    ShowSuccessMessage(result);
...
function DeleteRole(name,role){    
    if(role!==null&&name!==null){    
        ...
        dataString = "name="+name+"&groupname="+role;
         $.ajax({
                type: "POST",
                url: "https://localhost:7443/ActiveDirectoryWebAPI/RemoveUserFromGroup",
                data: dataString,
                dataType: "json",
               success: function(result) {
                    ShowSuccessMessage(result);
...
//check if all the input has value since they all are required for user registration    
    if(attributename!==null&&name!==null&&attributevalue!==null){ 
        var button;
        var modal;
        ...
        if(attributename==="department"){
         ...
         $.ajax({
                type: "POST",
                url: "https://localhost:7443/ActiveDirectoryWebAPI/UpdateAttribute",
                data: dataString,
                dataType: "json",
               success: function(result) {
                    ShowSuccessMessage(result);
...
//check if all the input has value since they all are required for user registration    
    if(attributename!==null&&name!==null&&attributevalue!==null){ 
        ...
        dataString = "name="+name+"&attributename="+attributename+"&attributevalue="+attributevalue;
         ...
         $.ajax({
                type: "POST",
                url: "https://localhost:7443/ActiveDirectoryWebAPI/DeleteAttribute",
                data: dataString,
                dataType: "json",
               success: function(result) {
