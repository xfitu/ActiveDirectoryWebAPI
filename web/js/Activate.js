/*
 * This jquery or javascript file is used in Activate.jsp page
 */
  ...
  function ActivateAccount(fname,lname){
    if(fname!==null&&lname!==null){    
      ...
      dataString = "fname=" + fname+"&lname="+lname;
            $.ajax({
                type: "POST",
                url: "https://localhost:7443/ActiveDirectoryWebAPI/ActivateAccount",
                data: dataString,
                dataType: "json",
  ...
  function ShowResult(result){
      if(result.Status==="success"){
         $("#result").html( "<h3><strong>Account Activation</strong></h3><br>"+
                     ...
                     "<br><span>go to <a href=login.jsp >login</a></span>");  
      }else{
         $("#result").html( "<h3><strong>Account Activation</strong></h3><br>"+
